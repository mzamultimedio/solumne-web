...
CREATE UNIQUE INDEX cursos_slug_unique ON cursos(slug);
...
CREATE INDEX curso_user_user_id_foreign ON curso_user(user_id);
...
CREATE UNIQUE INDEX exams_modulo_id_unique ON exams(modulo_id);
...
CREATE UNIQUE INDEX exam_answers_exam_attempt_id_exam_question_id_unique ON exam_answers(exam_attempt_id, exam_question_id);

CREATE INDEX exam_answers_exam_question_id_foreign ON exam_answers(exam_question_id);
...
CREATE UNIQUE INDEX exam_attempts_exam_id_user_id_unique ON exam_attempts(exam_id, user_id);

CREATE INDEX exam_attempts_user_id_foreign ON exam_attempts(user_id);
...
CREATE INDEX exam_questions_exam_id_foreign ON exam_questions(exam_id);
...
CREATE INDEX leccions_modulo_id_foreign ON leccions(modulo_id);
...
DROP TABLE IF EXISTS leccion_user;
...
CREATE TABLE leccion_user (
    ...
    created_at TEXT,
    updated_at TEXT,
    PRIMARY KEY (leccion_id, user_id),
    FOREIGN KEY (leccion_id) REFERENCES leccions(id) ON DELETE CASCADE,
    FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE
);

CREATE INDEX leccion_user_user_id_foreign ON leccion_user(user_id);
...
CREATE INDEX modulos_curso_id_foreign ON modulos(curso_id);
...
DROP TABLE IF EXISTS modulo_user;
...
CREATE UNIQUE INDEX modulo_user_modulo_id_user_id_unique ON modulo_user(modulo_id, user_id);

CREATE INDEX modulo_user_user_id_foreign ON modulo_user(user_id);

CREATE INDEX modulo_user_released_by_foreign ON modulo_user(released_by);

CREATE INDEX modulo_user_status_index ON modulo_user(status);

CREATE INDEX modulo_user_available_from_index ON modulo_user(available_from);

CREATE INDEX modulo_user_available_until_index ON modulo_user(available_until);
...
CREATE INDEX recursos_leccion_id_foreign ON recursos(leccion_id);
